//When someone types into the text field, I need a function that will analayze the text when someone hits the Analyze it button
//function that responds when the user clicks on the analyze it button
//this function takes the variable (the text types in) and analyzes it
//create a variable that = whatever is typed into the text box
//variable should be an array of words
//one function needs to count the length of the array to result in the total word count
//another aspect of the function needs to analyze the array to figure out the unique words
//another aspect needs to take the average length of the words-therefore each word needs to be an array too?
//another aspct needs to count the sentence length in words
//anything before a . ! or ? needs to be an array and i need to count the length of that array

//I need to first create the variables which would be array of words, array of letters
